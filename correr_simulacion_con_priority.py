from simularPriorityBoarding import simularConPriority10, Criterio
import random
import statistics
import csv
import numpy as np
...
def correr_experimento(criterio, iters, seed=100):
    ...
    for i in range(iters):
        res = simularConPriority10(FILAS, N_PASAJEROS, ASIENTOS_VALIDOS, P_CARRY_ON, T_SENTADO, T_CARRYON, VISUALIZAR, criterio)
...
Criterios = {Criterio.steffen, Criterio.por_zona}
